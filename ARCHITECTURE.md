...
| `strategies/{debate,council,moa,refine,ensemble,selfconsistency,selfmoa,reflexion,verify,cascade,selfdiscover}.py` | The deliberation algorithms | each exposes `run(ctx)` |
